...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (35609191)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (35609191)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (21498856,36309593,36310234,37079289,36310431)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (21498856,36309593,36310234,37079289,36310431)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (44810601,4271762,4139934,44788302,44788283,4019973,4190815,4307308,4192297,4307307,4193277,4052051,4076506,35610659,35610286,42690497,45765559,4137393,4144274,4053088,44790997,4091004,4090385,44806052,44793821,46272532,3656380,4022661)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (44810601,4271762,4139934,44788302,44788283,4019973,4190815,4307308,4192297,4307307,4193277,4052051,4076506,35610659,35610286,42690497,45765559,4137393,4144274,4053088,44790997,4091004,4090385,44806052,44793821,46272532,3656380)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (37208401,35609555)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (37208401,35609555)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (8672)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (8672)
  and c.invalid_reason is null
...
WHERE C.visit_start_date >= DATEFROMPARTS(2020, 1, 1)
-- End Visit Occurrence Criteria
...
) A on A.person_id = P.person_id  AND A.START_DATE >= DATEADD(day,0,P.START_DATE) AND A.START_DATE <= DATEADD(day,180,P.START_DATE) ) cc 
GROUP BY cc.person_id, cc.event_id
HAVING COUNT(cc.event_id) >= 1
-- End Correlated Criteria
...
) A on A.person_id = P.person_id  AND A.START_DATE >= DATEADD(day,0,P.START_DATE) AND A.START_DATE <= DATEADD(day,180,P.START_DATE) ) cc on p.person_id = cc.person_id and p.event_id = cc.event_id
